...
#define MATCH_RSLTN   25  

char Sample_No = 0;
char Sample_count = 0;
char Sample_Array[5][MAX_SAMPLE];
char ota_flag = 0;
...
void key_sence(void)
{ if(digitalRead(KEY1) == 0)  { Sample_No = 1;    ota_flag = 0; }
  if(digitalRead(KEY2) == 0)  { Sample_No = 2;    ota_flag = 0; }
if(digitalRead(KEY3) == 0)  { Sample_No = 3;      ota_flag = 0; }
  if(digitalRead(KEY4) == 0)  { Sample_No = 4;    ota_flag = 0; }
}
