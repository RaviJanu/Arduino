...
#define  NUM_RESULOTION    25 
#define  AMP_RESULOTION    3

char Sample_No = 0;
char Sample_count = 0;
unsigned int Sample_Array[3][MAX_SAMPLE];
char ota_flag = 0;
...
{ char i = 0,Sample_matched[2] = {0,0};
  ...
  { Serial.print("1 Sample Matched = ");
    Serial.print(Sample_matched[0],DEC);
    Serial.println("\n\n\n\r");
    
    while(digitalRead(KEY3) == 1){}
  } 
